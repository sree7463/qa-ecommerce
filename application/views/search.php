...
<?php // $this->load->view('includes/carousel.php'); ?>
	...
	<div class="row">
		...
		<div class="span9">		
			  ...
			  ?>
						<h4 class="pro_search_results">
							<strong><?php echo count($products); ?></strong>
							Result<?php if(count($products) > 1): ?>(s)<?php endif; ?> found for '<?php echo str_replace('+', ' ', $searched_word); ?>':
						</h4>
						  <ul class="thumbnails">
					<?PHP
				...
				?>
					<li class="span3">
					  <div class="thumbnail">
						<a  href="<?php echo $product_link; ?>"><img src="<?php echo base_url(); ?>Assets/images/products/<?php echo $image; ?>" width="150" alt="<?php echo $product->product_name; ?>" title="<?php echo $product->product_name; ?>"/></a>
						<div class="caption">
          ...
          <h2>No product found relating your searched term</h2>
